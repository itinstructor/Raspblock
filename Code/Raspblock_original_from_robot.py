...
#         print(bytes(Speed_Motion_CMD1))
    ...
    def Speed_axis_Yawhold_control(self, Speed_axis_X, Speed_axis_Y):
        ...
        Checknum = (Function + Length + Speed_axis_Mode + Speed_axis_XH +
                    Speed_axis_XL + Speed_axis_YH + Speed_axis_YL + Speed_axis_direction) & 0xff
...
#         print(bytes(Speed_Motion_CMD1))
    ...
    def Speed_Wheel_control(self, Speed_WheelA, Speed_WheelB, Speed_WheelC, Speed_WheelD):
        ...
        Speed_Motion_CMD2 = [0xFF, 0xFE, Function, Length, Speed_Wheel_Mode, Speed_Wheel_A, Speed_Wheel_B,
                             Speed_Wheel_C, Speed_Wheel_D, Speed_Wheel_Reserved1, Speed_Wheel_Reserved2, Speed_wheel_direction, Checknum]
#         print(bytes(Speed_Motion_CMD2))
    ...
    def Position_disp_control(self, Position_disp_X, Position_disp_Y, Position_disp_Z):
        ...
        Checknum = (Function + Length + Position_disp_Mode + Position_disp_XH + Position_disp_XL + Position_disp_YH +
                    Position_disp_YL + Position_disp_ZH + Position_disp_ZL + Position_disp_direction) & 0xff
        Position_Motion_CMD = [0xFF, 0xFE, Function, Length, Position_disp_Mode, Position_disp_XH, Position_disp_XL,
